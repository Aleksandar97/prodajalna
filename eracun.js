...
streznik.post('/izpisiRacunBaza', function(zahteva, odgovor) {
  ...
  fom.parse(zahteva, function (napaka1, polja, datoteke) {
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    var status = "Stranka je bila uspešno registrirana.";
    vrniStranke(function(napaka3, stranke) {
      vrniRacune(function(napaka4, racuni) {
         if (napaka1 || napaka2 || napaka3 || napaka4) {
           status = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
          }
